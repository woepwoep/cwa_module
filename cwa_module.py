...
class cwa_import_module(models.Model):
    ...
    def parse_xml_products(self, cr, uid, f):
        ...
        product_tags = ['id', 'name', 'list_price', 'ean13', 'categ_id/id', 
                        ...
                        'use_deposit', 'select_deposit', 'to_weight']
        ...
        for product in root.iter('product'):
            ...
            try:
                ...
                temp_data['select_deposit'] = statiegeld_translations[temp_data['statiegeld']] if temp_data['use_deposit'] != 'false' else 0
            except KeyError:
                temp_data['use_deposit'] = 'false'
                temp_data['select_deposit'] = 0                
            try:
